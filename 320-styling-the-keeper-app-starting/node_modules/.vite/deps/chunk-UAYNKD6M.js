...
var React8, syncFallback, useInsertionEffect2, useInsertionEffectAlwaysWithSyncFallback, useInsertionEffectWithLayoutFallback;
...
var React9, import_react8, isBrowser2, hasOwn, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
var init_emotion_element_43c6fea0_browser_esm = __esm({
  "node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js"() {
    ...
    EmotionCacheContext = React9.createContext(
    ...
    withEmotionCache = function withEmotionCache2(func) {
      return (0, import_react8.forwardRef)(function(props, ref) {
        var cache2 = (0, import_react8.useContext)(EmotionCacheContext);
      ...
      withEmotionCache = function withEmotionCache3(func) {
        return function(props) {
          ...
          if (cache2 === null) {
            ...
            return React9.createElement(EmotionCacheContext.Provider, {
              value: cache2
            }, func(props, cache2));
          } else {
    ...
    ThemeContext = React9.createContext({});
    if (true) {
...
var React10, import_hoist_non_react_statics2, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser3, isTestEnv, globalContext, globalKey;
  ...
  "node_modules/@emotion/react/dist/emotion-react.browser.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache2) {
      ...
      if (!isBrowser2) {
        ...
        return React10.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
...
var React11, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
var import_react10, tags, newStyled;
...
var React12, import_prop_types10, import_jsx_runtime, cache;
...
var React13, import_prop_types11, import_jsx_runtime2;
...
var maxWidth = (props) => {
  if (props.maxWidth !== void 0 && props.maxWidth !== null) {
    const styleFromPropValue = (propValue) => {
      ...
      const breakpoint = ((_props$theme = props.theme) == null || (_props$theme = _props$theme.breakpoints) == null || (_props$theme = _props$theme.values) == null ? void 0 : _props$theme[propValue]) || values2[propValue];
      if (!breakpoint) {
        return {
...
var maybeReactUseId = React20["useId".toString()];
...
function useIsFocusVisible() {
  const ref = React25.useCallback((node2) => {
    if (node2 != null) {
      prepare(node2.ownerDocument);
    }
  }, []);
  const isFocusVisibleRef = React25.useRef(false);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UAYNKD6M.js.map
